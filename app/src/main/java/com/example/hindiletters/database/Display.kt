...
import com.example.hindiletters.database.DBHelper


@Composable
fun FillData(navController: NavController){
    Surface(
        ...
        Scaffold(
            ...
            addDataToDatabase(LocalContext.current,navController=navController)
        }
    }
...
fun addDataToDatabase(
    ...
    Column(
        ...
        var dbHandler = DBHelper(context)
...
//        )
        ...
        Button(onClick = {
//            val i = Intent(context, ListOfLetters::class.java)
//            context.startActivity(i)
           navController.navigate("data_screen2")
        }) {
            // on below line adding a text for our button.
